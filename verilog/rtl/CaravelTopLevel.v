...
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
`endif // RANDOMIZE_REG_INIT
  reg [31:0] rdDataReg; // @[PipeConInterconnect.scala 14:26]
  wire  selected_wr = io_dmem_wrEnable_0 | io_dmem_wrEnable_1 | io_dmem_wrEnable_2 | io_dmem_wrEnable_3; // @[PipeConInterconnect.scala 47:34]
  wire [31:0] _GEN_31 = io_dmem_rdEnable ? io_dmem_rdAddress : 32'h0; // @[PipeConInterconnect.scala 33:20 59:33 63:22]
  wire [31:0] selected_address = selected_wr ? io_dmem_wrAddress : _GEN_31; // @[PipeConInterconnect.scala 47:41 50:22]
  wire  selected_rd = selected_wr ? 1'h0 : io_dmem_rdEnable; // @[PipeConInterconnect.scala 47:41 49:17]
  wire [31:0] _GEN_3 = io_dmem_wrAddress <= 32'hf ? io_device_0_rdData : 32'h0; // @[PipeConInterconnect.scala 41:74 42:16 36:19]
  wire [31:0] selected_wrData = selected_wr ? io_dmem_wrData : 32'h0; // @[PipeConInterconnect.scala 34:19 47:41 51:21]
  wire [3:0] _selected_wrMask_T = {io_dmem_wrEnable_3,io_dmem_wrEnable_2,io_dmem_wrEnable_1,io_dmem_wrEnable_0}; // @[PipeConInterconnect.scala 52:41]
  wire [3:0] selected_wrMask = selected_wr ? _selected_wrMask_T : 4'h0; // @[PipeConInterconnect.scala 35:19 47:41 52:21]
  wire [31:0] _GEN_10 = io_dmem_wrAddress >= 32'h10 & io_dmem_wrAddress <= 32'h1f ? io_device_1_rdData : _GEN_3; // @[PipeConInterconnect.scala 41:74 42:16]
  wire [31:0] _GEN_17 = io_dmem_wrAddress >= 32'h20 & io_dmem_wrAddress <= 32'h2f ? io_device_2_rdData : _GEN_10; // @[PipeConInterconnect.scala 41:74 42:16]
  assign io_device_0_rd = io_dmem_wrAddress <= 32'hf & selected_rd; // @[PipeConInterconnect.scala 41:74 42:16 22:21]
  assign io_device_0_wrData = io_dmem_wrAddress <= 32'hf ? selected_wrData : 32'h0; // @[PipeConInterconnect.scala 41:74 42:16 25:25]
  assign io_device_0_wrMask = io_dmem_wrAddress <= 32'hf ? selected_wrMask : 4'h0; // @[PipeConInterconnect.scala 41:74 42:16 26:25]
  assign io_device_1_rd = io_dmem_wrAddress >= 32'h10 & io_dmem_wrAddress <= 32'h1f & selected_rd; // @[PipeConInterconnect.scala 41:74 42:16 22:21]
  assign io_device_1_wrData = io_dmem_wrAddress >= 32'h10 & io_dmem_wrAddress <= 32'h1f ? selected_wrData : 32'h0; // @[PipeConInterconnect.scala 41:74 42:16 25:25]
  assign io_device_1_wrMask = io_dmem_wrAddress >= 32'h10 & io_dmem_wrAddress <= 32'h1f ? selected_wrMask : 4'h0; // @[PipeConInterconnect.scala 41:74 42:16 26:25]
  assign io_device_2_address = io_dmem_wrAddress >= 32'h20 & io_dmem_wrAddress <= 32'h2f ? selected_address : 32'h0; // @[PipeConInterconnect.scala 41:74 42:16 24:26]
  assign io_device_2_rd = io_dmem_wrAddress >= 32'h20 & io_dmem_wrAddress <= 32'h2f & selected_rd; // @[PipeConInterconnect.scala 41:74 42:16 22:21]
  assign io_device_2_wr = io_dmem_wrAddress >= 32'h20 & io_dmem_wrAddress <= 32'h2f & selected_wr; // @[PipeConInterconnect.scala 41:74 42:16 23:21]
  assign io_device_2_wrData = io_dmem_wrAddress >= 32'h20 & io_dmem_wrAddress <= 32'h2f ? selected_wrData : 32'h0; // @[PipeConInterconnect.scala 41:74 42:16 25:25]
  assign io_device_3_address = io_dmem_wrAddress >= 32'h10000000 & io_dmem_wrAddress <= 32'h1fffffff ? selected_address
     : 32'h0; // @[PipeConInterconnect.scala 41:74 42:16 24:26]
  assign io_device_3_rd = io_dmem_wrAddress >= 32'h10000000 & io_dmem_wrAddress <= 32'h1fffffff & selected_rd; // @[PipeConInterconnect.scala 41:74 42:16 22:21]
  assign io_device_3_wr = io_dmem_wrAddress >= 32'h10000000 & io_dmem_wrAddress <= 32'h1fffffff & selected_wr; // @[PipeConInterconnect.scala 41:74 42:16 23:21]
  assign io_device_3_wrData = io_dmem_wrAddress >= 32'h10000000 & io_dmem_wrAddress <= 32'h1fffffff ? selected_wrData : 32'h0
    ; // @[PipeConInterconnect.scala 41:74 42:16 25:25]
  assign io_device_3_wrMask = io_dmem_wrAddress >= 32'h10000000 & io_dmem_wrAddress <= 32'h1fffffff ? selected_wrMask : 4'h0
    ; // @[PipeConInterconnect.scala 41:74 42:16 26:25]
  assign io_dmem_rdData = rdDataReg; // @[PipeConInterconnect.scala 83:18]
  always @(posedge clock) begin
    if (reset) begin // @[PipeConInterconnect.scala 14:26]
      rdDataReg <= 32'h0; // @[PipeConInterconnect.scala 14:26]
    end else if (!(selected_wr)) begin // @[PipeConInterconnect.scala 47:41]
      if (io_dmem_rdEnable) begin // @[PipeConInterconnect.scala 59:33]
        if (io_dmem_wrAddress >= 32'h10000000 & io_dmem_wrAddress <= 32'h1fffffff) begin // @[PipeConInterconnect.scala 41:74]
          rdDataReg <= io_device_3_rdData; // @[PipeConInterconnect.scala 42:16]
        end else begin
          rdDataReg <= _GEN_17;
        end
      end
